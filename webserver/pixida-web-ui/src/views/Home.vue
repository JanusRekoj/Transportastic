<template>
  <div class="home">
    ...
    <!-- <b-container class="text-center m-5">
      <div class="display-3">Welcome to our project website!</div>
    </b-container> -->
    <!-- <b-container class="text-left">
      <h3>Some more info</h3>
      <p>
        Here, we can add some fancy marketnig info about this awesome project
